...
$check_query = "SELECT COUNT(*) as count FROM absences a JOIN eleves e ON a.eleve_id = e.id WHERE e.section = 'maternelle'";
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo BASE_URL; ?>index.php?controller=Directrice&action=eleves&section=maternelle">
            <i class="fa fa-users"></i> <span>Élèves Maternelle</span>
          </a>
        </li>
        
        <li>
          <a href="<?php echo BASE_URL; ?>index.php?controller=Directrice&action=professeurs&section=maternelle">
            <i class="fa fa-graduation-cap"></i> <span>Professeurs Maternelle</span>
          </a>
        </li>
        
        <li>
          <a href="<?php echo BASE_URL; ?>index.php?controller=Directrice&action=classes&section=maternelle">
            <i class="fa fa-table"></i> <span>Classes Maternelle</span>
          </a>
        </li>

...
// Récupération des cours de la section maternelle
$cours = [];
...
$classes = [];
$classes_query = "SELECT id, nom FROM classes WHERE section = 'maternelle' ORDER BY nom ASC";
...
<head>
  ...
  <title>SGS | Gestion des Cours Maternelle</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste des Cours - Section Maternelle</h3>
              <div class="box-tools">
  ...
  <div class="modal fade" id="modal-ajouter-cours">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo BASE_URL; ?>index.php?controller=Directrice&action=ajouterCours" method="post">
  ...
  <div class="modal fade" id="modal-modifier-cours">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo BASE_URL; ?>index.php?controller=Directrice&action=modifierCours" method="post">
          <div class="modal-body">
...
function confirmerSuppression(id, nom) {
  if (confirm('Êtes-vous sûr de vouloir supprimer le cours "' + nom + '" ?')) {
    window.location.href = '<?php echo BASE_URL; ?>index.php?controller=Directrice&action=supprimerCours&id=' + id;
  }
}
</script>
</body>

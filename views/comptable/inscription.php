...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
          ...
          <a href="<?php echo BASE_URL; ?>index.php?controller=comptable&action=accueil">
            <i class="fa fa-child"></i> <span>Accueil</span>
        ...
        <li>
          <a href="<?php echo BASE_URL; ?>index.php?controller=comptable&action=ajoutpaiement">
            <i class="fa fa-child"></i> <span>Paiement frais</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"></small>
            </span>
          </a>
        ...
        <li>
          <a href="<?php echo BASE_URL; ?>index.php?controller=comptable&action=paiements">
            <i class="fa fa-child"></i> <span>Eleves en ordres</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"></small>
            </span>
          </a>
  ...
  <div class="content-wrapper">
    ...
    <h2>INSCRIPTION</h2>
    <form method="POST" action="index.php?controller=comptable&action=inscriptions">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
              <div class="form-group">
                ...
                <select id="option_id" name="option_id" class="form-control select2" style="width: 60%;" >
            ...
            <div class="form-group">
                ...
                <select id="classe" name="classe_nom" class="form-control select2" style="width: 60%;" required>

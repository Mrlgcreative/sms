      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=professeurs"><i class="fa fa-circle-o"></i> Voir</a></li>
          </ul>
        </li>
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools no-print">
                <a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=ajoutprofesseur" class="btn btn-primary btn-sm">
                ...
                <tbody>
                  <?php foreach ($professeurs as $professeur) : ?>
                    <tr>
                      ...
                      <td><?php echo $professeur['adresse']; ?></td>
                      <td><?php echo $professeur['classe_id']; ?></td>
                      <td><?php echo $professeur['cours_id']; ?></td>
                      <td><?php echo $professeur['section']; ?></td>
                      <td class="no-print">
                        <a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=editProfesseur&id=<?php echo $professeur['id']; ?>" class="btn btn-warning btn-xs">
                          <i class="fa fa-edit"></i> Modifier
                        </a>
                        <a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=deleteProfesseur&id=<?php echo $professeur['id']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce professeur?');">
                          <i class="fa fa-trash"></i> Supprimer
                        </a>
                        <a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=viewProfesseur&id=<?php echo $professeur['id']; ?>" class="btn btn-info btn-xs">
...
<script>
  ...
  function printContent(elementId) {
    ...
    document.body.innerHTML = '<h1 style="text-align: center;">Liste des Professeurs</h1>' + content;
    window.print();

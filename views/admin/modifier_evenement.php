<?php
// Vue pour la modification d'un événement scolaire
...
<head>
  ...
  <title>SGS | Modifier un événement</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Modifier un événement scolaire
        <small>Mettre à jour les informations de l'événement</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active">Modifier un événement</li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-warning">
            ...
            <div class="alert alert-danger alert-dismissible">
              ...
              <?php echo isset($_GET['message']) ? htmlspecialchars($_GET['message']) : 'Une erreur est survenue lors de la modification de l\'événement.'; ?>
            </div>
            <?php endif; ?>
            
            <form role="form" method="post" action="<?php echo BASE_URL; ?>index.php?controller=Admin&action=modifierEvenement&id=<?php echo $evenement['id']; ?>">
              <div class="box-body">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="datetime-local" class="form-control" id="date_debut" name="date_debut" 
                             value="<?php echo date('Y-m-d\TH:i', strtotime($evenement['date_debut'])); ?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="datetime-local" class="form-control" id="date_fin" name="date_fin" 
                             value="<?php echo date('Y-m-d\TH:i', strtotime($evenement['date_fin'])); ?>" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="lieu" name="lieu" value="<?php echo htmlspecialchars($evenement['lieu']); ?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="responsable" name="responsable" 
                             value="<?php echo htmlspecialchars($evenement['responsable']); ?>" required>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="4"><?php echo htmlspecialchars($evenement['description']); ?></textarea>
                </div>
                
                <div class="form-group">
                  <label>Couleur de l'événement</label>
                  <div class="input-group my-colorpicker2">
                    <input type="text" class="form-control" name="couleur" value="<?php echo htmlspecialchars($evenement['couleur']); ?>">
  ...
  $(function () {
    ...
    $('#date_debut, #date_fin').on('change', function() {
      ...
      if(dateDebut && dateFin && new Date(dateFin) < new Date(dateDebut)) {
        ...
        $('#date_fin').val('<?php echo date('Y-m-d\TH:i', strtotime($evenement['date_fin'])); ?>');
      }
    });
  })
</script>

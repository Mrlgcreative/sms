...
<head>
  ...
  <title>SGS | Liste des Élèves</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Liste des Élèves
        <small>Gestion des élèves</small>
      </h1>
      <ol class="breadcrumb">
                  ...
                  <?php foreach ($eleves as $eleve) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=vieweleve&id=<?php echo $eleve['id']; ?>" class="btn btn-info btn-xs">
                          <i class="fa fa-eye"></i> Détails
                        </a>
                        <a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=carteEleve&id=<?php echo $eleve['id']; ?>" class="btn btn-primary btn-xs">
...
<script>
  ...
  function printContent(elementId) {
    ...
    document.body.innerHTML = '<h1 style="text-align: center;">Liste des Élèves</h1>' + content;
    window.print();

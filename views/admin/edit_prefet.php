...
<head>
  ...
  <title>Admin | Modifier un préfet</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=directeurs"><i class="fa fa-circle-o"></i> Directeurs</a></li>
            <li><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=directrices"><i class="fa fa-circle-o"></i> Directrices</a></li>
            <li class="active"><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=prefets"><i class="fa fa-circle-o"></i> Préfets</a></li>
            <li><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=employes"><i class="fa fa-circle-o"></i> Employés</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Modification d'un préfet
        <small>Modifier les informations d'un préfet</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=accueil"><i class="fa fa-dashboard"></i> Accueil</a></li>
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=prefets">Préfets</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo BASE_URL; ?>index.php?controller=Admin&action=editPrefet&id=<?php echo $prefet['id']; ?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrez le nom" value="<?php echo $prefet['nom']; ?>" required>
                </div>
                
                <div class="form-group">
                  <label for="prenom">Prénom</label>
                  <input type="text" class="form-control" id="prenom" name="prenom" placeholder="Entrez le prénom" value="<?php echo $prefet['prenom']; ?>" required>
                </div>
                
                <div class="form-group">
                  <label for="contact">Contact</label>
                  <input type="text" class="form-control" id="contact" name="contact" placeholder="Entrez le numéro de téléphone" value="<?php echo $prefet['contact']; ?>" required>
                </div>
                
                <div class="form-group">
                  <label for="email">Email</label>
                  <input type="email" class="form-control" id="email" name="email" placeholder="Entrez l'adresse email" value="<?php echo $prefet['email']; ?>" required>
                </div>
                
                <div class="form-group">
                  <label for="adresse">Adresse</label>
                  <input type="text" class="form-control" id="adresse" name="adresse" placeholder="Entrez l'adresse" value="<?php echo $prefet['adresse']; ?>" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="section" name="section" required>
                    ...
                    <option value="Maternelle" <?php echo ($prefet['section'] == 'Maternelle') ? 'selected' : ''; ?>>Maternelle</option>
                    <option value="Primaire" <?php echo ($prefet['section'] == 'Primaire') ? 'selected' : ''; ?>>Primaire</option>
                    <option value="Secondaire" <?php echo ($prefet['section'] == 'Secondaire') ? 'selected' : ''; ?>>Secondaire</option>
                  </select>
                </div>
              </div>
              <!-- /.box-body -->
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo BASE_URL; ?>index.php?controller=Admin&action=prefets" class="btn btn-default">Annuler</a>
              </div>
            </form>
          </div>
          <!-- /.box -->

        ...
        <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=modifierProfesseur&id=<?php echo $professeur['id']; ?>" class="btn btn-warning btn-block"><b>Modifier</b></a>
            </div>
          </div>
                ...
                <div class="box-body">
                  ...
                  if ($presence_result->num_rows > 0) {
                    ...
                    echo '<div class="alert alert-info">
                          ...
                          <a href="' . BASE_URL . 'index.php?controller=Director&action=presencesProfesseurs&professeur_id=' . $prof_id . '" class="btn btn-primary">

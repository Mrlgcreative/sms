            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo BASE_URL; ?>logout.php" class="btn btn-default btn-flat">Déconnexion</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=accueil"><i class="fa fa-home"></i> <span>Accueil</span></a></li>
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=eleves"><i class="fa fa-users"></i> <span>Élèves</span></a></li>
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=professeurs"><i class="fa fa-user-tie"></i> <span>Professeurs</span></a></li>
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=classes"><i class="fa fa-graduation-cap"></i> <span>Classes</span></a></li>
        <li class="active"><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=cours"><i class="fa fa-book"></i> <span>Cours</span></a></li>
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=absences"><i class="fa fa-calendar-times"></i> <span>Absences</span></a></li>
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=rapports"><i class="fa fa-chart-bar"></i> <span>Rapports</span></a></li>
        <li><a href="<?php echo BASE_URL; ?>index.php?controller=Director&action=profil"><i class="fa fa-user"></i> <span>Mon Profil</span></a></li>
      </ul>
    </section>
  </aside>
